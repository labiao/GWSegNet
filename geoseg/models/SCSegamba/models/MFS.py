...
import torch
from geoseg.models.SCSegamba.models.GBC import GBC, BottConv
from geoseg.models.SCSegamba.models.DySample import DySample
...
class MFS(nn.Module):
    def __init__(self, embedding_dim):
        ...
        self.linear_pred_1 = nn.Conv2d(2, 2, kernel_size=1)
